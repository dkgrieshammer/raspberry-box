...
# Thanks a lot to aidan woods for code & tutorial, finally a working version: https://www.aidanwoods.com/blog/building-a-wifi-enabled-usb-rubber-ducky/
...
echo "musicbox01234567890" > strings/0x409/serialnumber
echo "www.universal-interaction.com" > strings/0x409/manufacturer
